                ...
                <div class="row register-form">
                  <div class="col-sm-6">
                    <div class="modal-body">
                      <div class="form-group">
                        <label>Victim</label>
                        <input type="text" class="form-control" name="victim" value="{{$blotter->victim}}" disabled>
                      </div>
                  ...
                  <div class="col-sm-6">
                    <div class="modal-body">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="location" value="{{$blotter->location}}" disabled>
                      </div>
                      ...
                      <div class="modal-body">
                        <div class="form-group">
                          ...
                          <select class="form-control" name="status">
                            <option disabled>Select Blotter Status</option>
                            <option selected="
                            {{ $blotter->status === 'Active'  }}" value="Active">Active</option>
                            <option selected="
                            {{ $blotter->status === 'Settled'  }}" value="Settled">Settled</option>
                            <option selected="
                            {{ $blotter->status === 'Scheduled'  }}" value="Scheduled">Scheduled</option>
                          </select>
                        </div>
                      </div>
