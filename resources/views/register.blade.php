    ...
    <div class="row align-items-center h-100">
      <form method="POST" enctype="multipart/form-data" action="/register" class="col-lg-6 col-md-8 col-10 mx-auto">
        ...
        <div class="mx-auto text-center my-4">
          ...
          <a class="navbar-brand mx-auto mt-2 flex text-center" href="./index.html">
            <img src="{{$settings->barangay_logo ? asset ($settings->barangay_logo) : asset('no/-image.png')}}" style="width: 30%">
          </a>
          @endforeach
